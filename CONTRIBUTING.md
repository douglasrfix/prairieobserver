...
Welcome to `prairieobserver` contributor's guide.
...
If you experience bugs or general issues with `prairieobserver`, please have a look
...
You can help improve `prairieobserver` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`prairieobserver` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `prairieobserver`'s files. While this mechanism can
...
```
conda create -n prairieobserver python=3 six virtualenv pytest pytest-cov
conda activate prairieobserver
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/prairieobserver.git
   cd prairieobserver
   ```
...
5. Install [pre-commit]:
   ...
   `prairieobserver` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/prairieobserver
[issue tracker]: https://github.com/<USERNAME>/prairieobserver/issues
